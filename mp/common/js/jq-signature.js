  ...
  */
  ...
  Signature.prototype = {
	...
	setData: function(data){
		...
		var img = new Image();
		var _max_width = this.settings.width;
		var _max_height = this.settings.height;
        img.src=data;
		...
		img.onload = function(){
			...
			if(dimg_h>_max_height){
				dimg_h = _max_height;
				dimg_w = Math.ceil(dimg_h*img_w/img_h);
			}
			console.debug(img_w,img_h,_max_width,_max_height);
            ctx.drawImage(img,0,0,dimg_w, dimg_h);
        }
	},
