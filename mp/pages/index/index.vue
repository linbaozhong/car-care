<template>
	<view class="content">
		<canvas canvas-id="firstCanvas" class="signature" :style="{width:width+'rpx',height:height+'rpx'}" @touchstart="onTouchstart"
		 @touchmove="onTouchmove" @touchend="onTouchend" @error="canvasIdErrorCallback"></canvas>
	</view>
</template>
